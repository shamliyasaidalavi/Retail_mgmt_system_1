...
class Adgodwn extends StatelessWidget {
      ...
      body: Column(
        children: [
          ...
          GestureDetector(
            ...
            child: FutureBuilder<List<godowModel>>(
                future: client.fetchgodown(),
                builder: (BuildContext context,
                    AsyncSnapshot<List<godowModel>> snapshot) {
                  if (snapshot.hasData) {
                    return ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Text(
                            "Counterid:${(snapshot.data![index].logid)}",
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14,
                            ),
         ...
         FutureBuilder<List<godowModel>>(
        future: client.fetchgodownap(),
    builder: (BuildContext context,
    AsyncSnapshot<List<godowModel>> snapshot) {
    if (snapshot.hasData) {
      return ListView.separated(
